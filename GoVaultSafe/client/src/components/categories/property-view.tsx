...
import { Building, Car, Gem, Home, Plus, Edit, Eye, TrendingUp, Network } from 'lucide-react';
import { DocumentRelationships } from '@/components/relationships/document-relationships';
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-600">{formatCurrency(property.currentValue)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Appreciation:</span>
                            <span className={`font-medium ${appreciation >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                              {formatCurrency(appreciation)} ({appreciationPercent >= 0 ? '+' : ''}{appreciationPercent.toFixed(1)}%)
                            </span>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          {property.lastAppraisal && (
                            <div>
                              ...
                              <p className="font-medium">{property.lastAppraisal}</p>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2 text-sm">
                          <div>
                            <span className="text-gray-600">Loan Information:</span>
                            <p className="font-medium">{property.loanInformation}</p>
                          </div>
                          <div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          value={`${stats.appreciation >= 0 ? '+' : ''}${formatCurrency(stats.appreciation)}`}
          icon={TrendingUp}
          color={stats.appreciation >= 0 ? 'green' : 'red'}
        />
        <StatCard
