  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <StatCard
          title="Liquid Assets"
          value={formatCurrency(getTotalByCategory('checking') + getTotalByCategory('savings'))}
          icon={Building2}
          color="blue"
        />
        <StatCard
          title="Investments"
          value={formatCurrency(getTotalByCategory('investment') + getTotalByCategory('retirement'))}
          icon={TrendingUp}
          color="purple"
        />
        <StatCard
          title="Total Debt"
          value={formatCurrency(Math.abs(getTotalByCategory('loan') + getTotalByCategory('credit')))}
          icon={CreditCard}
          color="red"
        />
      </div>
