...
import { Shield, Home, DollarSign, Umbrella, Gavel, Heart, IdCard, Building, Search, BarChart, Settings, MoreVertical } from 'lucide-react';
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        ...
        <div className="pt-4">
          ...
          {categories?.map((category) => {
            const IconComponent = categoryIcons[category.name.toLowerCase().replace(' ', '_') as keyof typeof categoryIcons] || Building;
            const colorClass = categoryColors[category.name.toLowerCase().replace(' ', '_') as keyof typeof categoryColors] || 'text-gray-500';
