...
export class GoogleSheetsService {
  ...
  // User management methods for Google-only architecture
  async getUserPermissions(spreadsheetId: string, email: string) {
    try {
      const data = await this.getData(spreadsheetId, 'Users_Permissions');
      const headers = data[0] || [];
      const userRow = data.find((row: any[]) => row[0] === email);
      ...
      const user = {
        googleId: email,
        email: userRow[0],
        role: userRow[1] as "owner" | "spouse" | "child" | "dependent" | "advisor" | "attorney" | "tax_preparer",
        name: userRow[1] || 'User', // Default name from role if not provided
        picture: undefined,
  ...
  async createUserPermissions(spreadsheetId: string, user: any) {
    try {
      // Default permissions based on role
      const rolePermissions = {
        owner: [true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true],
        spouse: [true, true, true, true, true, true, true, false, true, true, true, false, true, false, true, false, true, true],
        child: [true, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, true, false],
        dependent: [true, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, true, false],
        advisor: [false, false, true, false, false, false, false, false, true, false, true, false, false, false, false, false, true, false],
        attorney: [false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, true, false],
        tax_preparer: [false, false, true, false, false, false, false, false, true, false, true, false, false, false, false, false, true, false]
      };

      const permissions = rolePermissions[user.role as keyof typeof rolePermissions] || rolePermissions.dependent;
      ...
      await this.addData(spreadsheetId, 'Users_Permissions', userData);

      return {
        googleId: user.email,
        email: user.email,
        name: user.name || user.role,
        role: user.role as "owner" | "spouse" | "child" | "dependent" | "advisor" | "attorney" | "tax_preparer",
