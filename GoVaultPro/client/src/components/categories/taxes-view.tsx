  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-blue-600">{stats.filedReturns}</div>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            {stats.pendingReturns > 0 && <AlertTriangle className="h-4 w-4 text-yellow-500 mt-1" />}
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-purple-600">{formatCurrency(stats.totalEstimated)}</div>
            <p className="text-sm text-gray-600">Estimated Payments</p>
          </CardContent>
        </Card>
      </div>
