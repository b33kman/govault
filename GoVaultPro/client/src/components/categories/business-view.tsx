  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-yellow-600">{stats.upcomingDeadlines}</div>
            <p className="text-sm text-gray-600">Upcoming Deadlines</p>
            {stats.upcomingDeadlines > 0 && <AlertTriangle className="h-4 w-4 text-yellow-500 mt-1" />}
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-blue-600">{stats.totalEntities}</div>
            <p className="text-sm text-gray-600">Business Entities</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-purple-600">{stats.totalRequirements}</div>
            <p className="text-sm text-gray-600">Annual Requirements</p>
          </CardContent>
        </Card>
      </div>
